...
import { createMaterialProveedor, deleteMaterialProveedor, getMaterialProveedor, getMaterialProveedorById, getMaterialProveedorByMaterialId, updateMaterialProveedor } from "../handlers/material_proveedor";
...
router.get("/:id_material",
    param('id_material').isInt().withMessage("ID no valido"),
    handleInputErrors,
    getMaterialProveedorByMaterialId
